...
namespace Kdig\OrientBundle\Form\Samplevoc;
...
class VocSampleTypeFilterType extends AbstractType
{
    ...
    {
        return 'kdig_orientbundle_samplevoc_vocsampletypefiltertype';
    }
}
