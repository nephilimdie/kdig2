...
class PhotolistFilterType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('fromnumber', 'filter_number_range')
            ->add('tonumber', 'filter_number_range')
        ;
    ...
    {
        return 'kdig_orientbundle_photolistfiltertype';
    }
}
