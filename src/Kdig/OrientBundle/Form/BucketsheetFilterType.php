...
class BucketsheetFilterType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('isread', 'filter_choice')
            ->add('isdrawn', 'filter_choice')
            ->add('isnumbered', 'filter_choice')
            ->add('isfiled', 'filter_choice')
    ...
    {
        return 'kdig_orientbundle_bucketsheetfiltertype';
    }
}
