 ...
 * @Gedmo\Loggable
 * @ORM\Entity(repositoryClass="Kdig\OrientBundle\Repository\VocObjDecorationRepository")
 */
class VocObjDecoration {
    ...
    /** 
     * @ORM\OneToMany(targetEntity="Kdig\OrientBundle\Entity\Object", mappedBy="decoration") 
     */
    private $object;
    /**
     * Constructor
