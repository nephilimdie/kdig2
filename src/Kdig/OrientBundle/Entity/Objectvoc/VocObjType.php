...
/**
 * @ORM\Entity
 * @ORM\Table(name="voc_obj_type", schema="public")
 * @Gedmo\Loggable
 * @ORM\Entity(repositoryClass="Kdig\OrientBundle\Repository\VocObjTypeRepository")
 */
class VocObjType {
    ...
    /** 
     * @ORM\OneToMany(targetEntity="Kdig\OrientBundle\Entity\Object", mappedBy="type") 
     */
    private $object;
