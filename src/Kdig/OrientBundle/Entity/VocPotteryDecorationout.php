...
class VocPotteryDecorationout {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="VocColor", inversedBy="vocpotdecout" ) 
     */
    protected $color;

    /** @ORM\ManyToOne(targetEntity="Pottery", inversedBy="potdecorationout" ) */
    protected $pottery;

    /** 
     * @ORM\ManyToOne(targetEntity="VocDecorationOption", inversedBy="decorationout" ) 
     */
