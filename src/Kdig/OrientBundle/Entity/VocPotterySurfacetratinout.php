...
class VocPotterySurfacetratinout {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="VocColor", inversedBy="pottery_surfacetratinout" ) 
     */
    protected $color;

    /** @ORM\ManyToOne(targetEntity="Pottery", inversedBy="surfacetratinout" ) */
    protected $pottery;

    /** @ORM\ManyToOne(targetEntity="VocSurfaceTratOption", inversedBy="surfaceinout" ) */
