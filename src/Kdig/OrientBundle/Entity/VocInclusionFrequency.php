...
/**
 * @ORM\Entity
 * @ORM\Table(name="voc_inclusion_frequency", schema="public")
 * @Gedmo\Loggable
 */
class VocInclusionFrequency {
    ...
    /** 
     * @ORM\OneToMany(targetEntity="Pottery", mappedBy="inclusionfrequency") 
     */
    private $pottery;
     ...
     */
    public function addPottery(\Kdig\ArchaelogicalBundle\Entity\Pottery $pottery)
    {
