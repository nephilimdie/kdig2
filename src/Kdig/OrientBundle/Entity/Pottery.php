...
class Pottery {
    ...
    */
     ...
     * @GRID\Column(field="surfacetratout.vocsurfacetratoption", title="Surface Treatament Out", type="array", joinType="inner")
     */
