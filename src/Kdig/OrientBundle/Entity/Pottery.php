...
class Pottery {
    ...
    */
     ...
     * @GRID\Column(field="surfacetratout.color.name", title="Surface Treatament Out", type="array", joinType="inner")
     */
