 ...
 * @ORM\Entity(repositoryClass="Kdig\OrientBundle\Repository\PotteryRepository")
...
class Pottery {
    ...
    /**
     * @ORM\OneToOne(targetEntity="Kdig\ArchaeologicalBundle\Entity\Prepottery", inversedBy="pottery", cascade={"persist", "remove"})
    ...
    */
     ...
     * @ GRID\Column(field="surfacetratout", title="Surface Treatament Out")
     */
    ...
    public function setPrepottery(\Kdig\ArchaeologicalBundle\Entity\Prepottery $prepottery = null)
    {
        ...
        if($prepottery != null) $prepottery->setPottery($this);
        return $this;
    }
