...
class VocPotteryDecorationinout {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="VocColor", inversedBy="vocpotdecinout" ) 
     */
    protected $color;

    /** 
     * @ORM\ManyToOne(targetEntity="Pottery", inversedBy="potdecorationinout" ) 
     */
    protected $pottery;

    /** 
     * @ORM\ManyToOne(targetEntity="VocDecorationOption", inversedBy="decorationinout" ) 
     */
