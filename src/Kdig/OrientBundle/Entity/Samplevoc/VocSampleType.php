...
namespace Kdig\ArchaelogicalBundle\Entity\Samplevoc;
...
class VocSampleType {
    ...
    /** 
     * @ORM\ManyToOne(targetEntity="Kdig\ArchaelogicalBundle\Entity\Sample", inversedBy="type") 
     */
    private $sample;
     ...
     * Set sample
     *
     * @param Kdig\ArchaelogicalBundle\Entity\Sample $sample
     */
    public function setSample(\Kdig\ArchaelogicalBundle\Entity\Sample $sample)
    {
        $this->sample = $sample;
    }
     ...
     * Get sample
     *
     * @return Kdig\ArchaelogicalBundle\Entity\Sample 
     */
