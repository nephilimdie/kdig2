...
class Role
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Kdig\UserBundle\Entity\Ressource")
     ...
     * Add accessControl
     *
     * @param \Kdig\UserBundle\Entity\Ressource $accessControl
     */
    public function addRessource(\Kdig\UserBundle\Entity\Ressource $accessControl)
    {
